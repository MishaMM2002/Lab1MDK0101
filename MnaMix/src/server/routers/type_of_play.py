import fastapi
from src.server.resolves import type_of_play as resolve
from src.database.models import TypeOfPlay as Model

router = fastapi.APIRouter(prefix='/type_of_play', tags=['Type of play'])
